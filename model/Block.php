...
class Block extends BaseModel{
	...
	public function getBlocksWithContentNum() {
		$arr = $this->db->queryForArray("(select a.block_id,b.block_name, count(1) content_num from content a left join block b on a.block_id=b.block_id group by a.block_id,b.block_name) tmp");
		return $arr;
	}
