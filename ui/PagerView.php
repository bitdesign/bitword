	...
	$(function(){
		$("#navdiv a").click(function(){
			...
			<div id="navdiv" style="float:right;">
				...
				<ul class="pagination">
					<?
					if( $this->pageNo == 1){ 	echo "<li class='disabled'><a>$tfirst[$lan]</a></li><li class='disabled'><a>&laquo;</a></li>"; }
					else {	echo "<li><a href='#' id='first'>$tfirst[$lan]</a></li><li><a href='#' id='pre'>&laquo;</a></li>"; }
					...
					if($this->pageNo == $totPageNum)	{ echo "<li class='disabled'><a>&raquo;</a></li><li class='disabled'><a>$tlast[$lan]</a></li>"; }
					else { echo "<li><a href='#' id='next'>&raquo;</a></li><li><a href='#' id='last'>$tlast[$lan]</a></li>";}
					?>
