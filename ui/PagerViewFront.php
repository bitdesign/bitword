			...
			<style>
				#navdiv a{
					text-decoration:none; border:none; background:rgb(252,252,252);
			...
			<div id="navdiv" style="float:right; margin:30px 30px 0 0;">
				<?
				...
				if($totPageNum <= 1){}
					...
					while($c <= $totPageNum){
						...
						if($c == $this->pageNo){ echo "<a href='#' id='$c' style='border:1px solid rgb(217,217,217);'>$c</a>";}
