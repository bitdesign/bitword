		...
		<script language="javascript" type="text/javascript">
			...
			// template -- end--
				...
				function showPasswordDig(){
					popdiv('265','187',"Admin!changePassWordPage",'<?=$tdoset[$lan]?>');
				}
				function showDosetDig(){
					popdiv('750','310',"Setting!settingPage",'<?=$tdoset[$lan]?>');
				}
		...
		<body>
			<div class="all">
				...
				<div class="main">
					...
					<div class="location">
						<a id="nav"><?=$tcontents[$lan].">".$tsetting[$lan]?></a>
					</div>
					<div class="right">
						<div class="content">
							<div class="pageContent">
								<!-- Setting start-->
								<fieldset>
									<legend><?=$tdoset[$lan]?></legend>
									<div style="float:left;width:100%;">
										<input type="button" class="large_btn" value="<?=$tpassword[$lan] ?>" onclick="showPasswordDig();" />
										<input type="button" class="large_btn" value="<?=$tdoset[$lan] ?>" onclick="showDosetDig();" />
									</div>
								</fieldset>
								<!-- Setting end-->
								<!--template start-->
								<fieldset>
									<legend><?=$ttheme[$lan]?></legend>
									<div style="float:left;width:100%;height:300px;">
										<form action="Admin!unzip" method="POST" id="myform">
											<div style="float:left;width:100%;margin-bottom:10px;">
												...
												<input class="input_btn"  name="fileNameBrowse" type="button" value="<?=$tupload[$lan]?>" />
