	...
	<body>
		<div class="container">
			...
			<form class="form-signin" role="form" id="myform">
				...
				<div class="checkbox">
					<label>
						<input type="checkbox" value="on" name="remember" <?=$remember?>/> Remember me
					</label>
				</div>
				<button class="btn btn-lg btn-primary btn-block" type="button" id="dosub" onclick="doLogin();">Sign in</button>
			</form>
