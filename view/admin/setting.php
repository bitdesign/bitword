...
<html>
	<head>
		...
		<script language="javascript" type="text/javascript">
			...
			$(function(){
				$("input[type=radio][value=<?=$commentswitch?>]").attr("checked",'checked');
		...
		<div id="wrapper">
			...
			<div id="page-wrapper">
				...
				<div class="container-fluid">
					...
					<div class="row">
						<div class="col-lg-12">
							<h1 class="page-header"><?=$tdoset[$lan]?></h1>
							<ol class="breadcrumb">
								<li>
									<i class="fa fa-dashboard"></i>  <a href="Admin!dashboard">Dashboard</a>
								</li>
								<li class="active">
									<i class="fa fa-wrench"></i> <?=$tdoset[$lan]?>
								</li>
							</ol>
						</div>
					</div>
